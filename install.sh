...
updateV2RayAgent() {
	...
	echoContent skyBlue "wget -P /root -N --no-check-certificate https://raw.githubusercontent.com/jiayangkui/immortalwrt/openwrt-18.06/install.sh && chmod 700 /root/install.sh && /root/install.sh"
	echo
	exit 0
}
